...
*/
    ...
    public void testGetLocation() {
        assertNull("getLocation should return null if location is not set", supply.getLocation());
    }

    @Test
    public void testSetLocation() {
        String newLocation = "Shelter A";
        supply.setLocation(newLocation);
        assertEquals("setLocation should update the location", newLocation, supply.getLocation());
    }
}
